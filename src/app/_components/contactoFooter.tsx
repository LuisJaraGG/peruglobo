...
export function ContactoFooter() {
    return (
        ...
        <div className="relative w-screen h-full py-28">
              ...
              ></div>
              <div className="relative z-10 text-center px-3 max-w-[1200px] mx-auto flex flex-col md:flex-row items-center md:items-start md:justify-center text-white md:gap-16">
                  <Image src="/peru-globo-logo.png" alt="logo-peru-globo" width={136} height={76} className="w-[136px] md:my-auto" />
                  <div>
                    <p className="shabby-patty text-white text-5xl  md:text-7xl  underline-custom mt-10 md:m-0">Contáctanos</p>
                  ...
                  <div >
                    <p className="shabby-patty text-white text-5xl  md:text-7xl  underline-custom mt-14 md:m-0">Siguenos</p>
